...
export class MathOperationsComponent {
            ...
            <div class="math-operations mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body">
                                <h5 class="card-title">Сумма диагоналей матрицы</h5>
                                ...
                                <button id="calculate-diagonals" class="btn btn-secondary">Вычислить</button>
    ...
    render() {
        ...
        checkBtn.addEventListener('click', () => {
            ...
            const isPal = MetParamIsPalindrome(str);
        ...
        calcBtn.addEventListener('click', () => {
            ...
            try {
                ...
                const total = MetParamSumDiagonals(parsed);
